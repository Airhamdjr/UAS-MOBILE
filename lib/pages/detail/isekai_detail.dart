...
class IsekaiDetailPage extends StatelessWidget {
  final IsekaiModal isekai;

  const IsekaiDetailPage({Key? key, required this.isekai}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Description: ${isekai.description}',
                  style: TextStyle(
                    fontSize: 18,
